		...
		function (t, e, s) {
			...
			const _t = (t, e, s, n, i) => {
				...
				Lt = (t, e) =>
					null === t
						? 512
						: Math.max(512, Math.min(16384, Math.pow(2, Math.round(Math.log2(t * e))))),
				zt = async (t, e) =>
					new t(
						await ((t) =>
							new Promise((e, s) => {
					...
					(t, e) => {
						...
						try {
							...
							return s instanceof Promise
								? (we.set(t, s),
								  s.catch(() => !1).then((e) => (we.delete(t), be.set(t, e), e)))
								: (be.set(t, s), s)
						} catch {
							return be.set(t, !1), !1
						}
			...
			const Ye = ((t, e, s, n, i, o) =>
				...
				He = new WeakSet(),
				$e = ((t) =>
					null === t ? null : t.hasOwnProperty("AudioBuffer") ? t.AudioBuffer : null)(Te),
											...
											e !== s &&
												...
												("exponentialRampToValue" === s.type
													...
													: "setValueCurve" === s.type &&
													  m.setValueCurveAtTime(s.values, s.startTime, s.duration))
									}
									return w
								},
					...
					class extends f {
						constructor(e, s) {
							super(e, s),
								...
								(this._audioWorklet =
									void 0 === t ? void 0 : { addModule: (e, s) => t(this, e, s) })
						}
						get audioWorklet() {
				...
				Kn = () =>
					(async (t, e, s, n, i, o, r, a, c, h, u, l, p, d, f, _) => {
						if (
							...
							return (await Promise.all([t(n, n), t(r, r), t(f, f), t(_, _)])).every(
								(t) => t,
							)
						}
						return !1
			...
			const mi = "object" == typeof self ? self : null,
				gi =
					mi && (mi.hasOwnProperty("AudioContext") || mi.hasOwnProperty("webkitAudioContext"))
			function vi(t, e, s, n) {
				var i,
					o = arguments.length,
			...
			class Gi extends Wi {
				...
				createAudioWorkletNode(t, e) {
					return (function (t, e, s) {
						return (
							ti(ci(zn), "This node only works in a secure context (https or localhost)"),
							new zn(t, e, s)
						)
					})(
						/*! *****************************************************************************
...
***************************************************************************** */ this.rawContext,
						...
						tr: {
							method: (t, e, s) => {
								...
								return (
									t &&
										"0" !== t &&
										(n += this._beatsToUnits(this._getTimeSignature() * parseFloat(t))),
				...
				getValueAtTime(t) {
					...
					if (null === n) i = this._initialValue
						...
						;(s = null === t ? this._initialValue : t.value),
							"setTargetAtTime" === n.type &&
								(i = this._exponentialApproach(n.time, s, n.value, n.constant, e))
					}
			...
			class Ro extends vo {
				...
				cancel(t) {
					return (
						(t = this.toSeconds(t)), this._state.cancel(t), this._tickOffset.cancel(t), this
					)
				}
				getTicksAtTime(t) {
					const e = this.toSeconds(t),
			...
			class Bo extends Ei {
				...
				add(t) {
					...
					for (
						null === this._root ? (this._root = e) : this._root.insert(e), this._length++;
						null !== e;
			...
			class Go extends wo {
				constructor() {
					...
					;(this.input = this.output =
						new ko({ context: this.context, gain: t.volume, units: "decibels" })),
			...
			class Ho extends wo {
				constructor(t) {
					super(t),
						...
						(this._volume = this.output =
							new Go({ context: this.context, mute: t.mute, volume: t.volume })),
				...
				start(t, e, s) {
					...
					if (
						...
						if (
							(this.log("start", n), this._state.setStateAtTime("started", n), this._synced)
						) {
			...
			class br extends Ho {
				...
				set playbackRate(t) {
					...
					s &&
						s.implicitEnd &&
						(this._state.cancel(s.time), this._activeSources.forEach((t) => t.cancelStop())),
			...
			class Tr extends wo {
				...
				player(t) {
					if (
						(ti(this.has(t), `No Player with the name ${t} exists on this object`),
						!this._players.has(t))
					) {
						const e = new br({
							context: this.context,
			...
			class qr extends Do {
				...
				_onTick(t) {
					...
					this._lastVal !== e &&
						((this._lastVal = e), this._constantSource.offset.setValueAtTime(e, t))
				}
				_anchorValue(t) {
					const e = super.getValueAtTime(this.context.transport.seconds)
					;(this._lastVal = e),
			...
			class Yr extends Nr {
				constructor() {
					...
					;(this.detune = new Do({ context: this.context, units: "cents", value: t.detune })),
						(this.frequency = new Do({ context: this.context, units: "frequency" })),
						(this._amplitude = new ko({ context: this.context, gain: 0 }).connect(
							this.output,
						)),
			...
			class $r extends Vr {
				...
				sync() {
					return (
						this._syncState() &&
							(this._syncMethod("triggerAttack", 0), this._syncMethod("triggerRelease", 0)),
						this
					)
				}
				triggerAttackRelease(t, e, s = 1) {
				...
				constructor() {
					...
					;(this._combFilter = this.output =
						...
						(this._lowpass = this.input =
							new na({ context: this.context, frequency: t.dampening, type: "lowpass" })),
						...
						if ("started" === t.state) {
							...
							if (!0 === this._loop || (ui(this._loop) && this._loop > 1)) {
								...
								null !== n && (e = Math.min(e, n.time - s)),
									e !== 1 / 0 &&
										(this._state.setStateAtTime("stopped", s + e + 1, { id: -1 }),
			...
			function* _a(t, e) {
				...
				for (;;)
					(s = fa(s, t)),
						yield t[s],
						e ? (s++, s >= t.length - 1 && (e = !1)) : (s--, s <= 0 && (e = !0))
			}
			function* ma(t) {
				let e = 0,
					s = 0
			...
			class wa extends ca {
				...
				set loopEnd(t) {
					;(this._loopEnd = t),
						(this._part.loopEnd =
							0 === t ? this._indexTime(this._eventsArray.length) : this._indexTime(t))
				}
				get startOffset() {
			...
			class Pa extends Ta {
				...
				set distortion(t) {
					...
					this._shaper.setMap((t) =>
						Math.abs(t) < 0.001 ? 0 : ((3 + e) * t * 20 * s) / (Math.PI + e * Math.abs(t)),
					)
				}
				get oversample() {
					return this._shaper.oversample
			...
			class dc extends wo {
				...
				_noSolos() {
					return (
						...
						(dc._soloed.has(this.context) && 0 === dc._soloed.get(this.context).size)
					)
				}
				_updateSolo() {
			...
			class fc extends wo {
				constructor() {
					...
					;(this._panner = this.input =
						new Ca({ context: this.context, pan: t.pan, channelCount: t.channelCount })),
			...
			class _c extends wo {
				...
				_getBus(t) {
					return (
						_c.buses.has(t) || _c.buses.set(t, new ko({ context: this.context })),
						_c.buses.get(t)
					)
				}
				send(t, e = 0) {
